    ...
    useEffect(() => {
        const fetchUserPets = async () => {
            try {
                ...
                const pets = await getPetsByUser(data.id_user);
            ...
            <div className="w-max mt-12 bg-white rounded">
                <div className="py-5 px-10">
                    ...
                    <div className="flex flex-wrap justify-center">
                        {userPets.map((pet) => (
                            <div key={pet.id_mascota} className="m-2" onClick={() => handlePetSelection(pet)}>
                    ...
                    <div>
                        <p>
                            mascota seleccionada: {petSelected ? petSelected.nombre_mascota : "Ninguna"}
                        </p>
                    </div>
