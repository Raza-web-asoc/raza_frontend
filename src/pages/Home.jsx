        ...
        <div className="bg-gray-900 text-white min-h-screen">
            ...
            <section className="grid md:grid-cols-3 gap-8 px-8 pt-10 pb-16 max-w-5xl mx-auto text-center">
                ...
                <div className="p-6 bg-gray-800 rounded-lg shadow-lg">
                    <img src="src/assets/1.jpg" alt="Match" className="mx-auto mb-4 w-50 rounded-lg" />
                ...
                <div className="p-6 bg-gray-800 rounded-lg shadow-lg">
                    <img src="https://i0.wp.com/tekiosmag.com/wp-content/uploads/2023/01/screenshot-pixabay.com-2023.01.15-23_10_07.png" alt="Chat" className="mx-auto mb-4 w-50 rounded-lg" />
                ...
                <div className="p-6 bg-gray-800 rounded-lg shadow-lg">
                    <img src="https://carnavaldorado.com/wp-content/uploads/2023/11/Crecimiento-del-Golden-Retriever.webp" alt="Perfil" className="mx-auto mb-4 h-40 rounded-lg" />
            ...
            <section className="pt-5 pb-20 max-w-3xl mx-auto flex flex-col md:flex-row items-center" id="mision">
                <div className="md:w-1/2 mb-6 md:mb-0 flex items-center justify-center">
                    <img src="src/assets/mision.jpg" alt="Imagen de Misión y Visión" className="rounded-lg shadow-lg w-5/6" />
                </div>
